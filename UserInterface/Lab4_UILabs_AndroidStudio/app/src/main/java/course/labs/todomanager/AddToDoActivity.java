...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// TODO - Set up OnClickListener for the Reset Button DONE
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
    			...
    			// TODO - Reset data to default values DONE

                mTitleText.setText("");
                //RadioButton mStatusDoneButton = (RadioButton)findViewById(R.id.statusDone);
                //mStatusDoneButton.setChecked(false);
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - Get the current Priority DONE
				Priority priority = getPriority();

				// TODO - Get the current Status DON
				Status status = getStatus();

				// TODO - Get the current ToDoItem Title DONE
				...
				// TODO - return data Intent and finish DONE

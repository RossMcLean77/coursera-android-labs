...
public class DownloaderTaskFragment extends Fragment {
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		@Override
		protected String[] doInBackground(Integer... sRawTextFeedIds) {
			Log.v(TAG, "DownloaderTask.doInBackground()");
			return downloadTweets(sRawTextFeedIds);
		}

		@Override
		protected void onPreExecute() {
			super.onPreExecute();
			Log.v(TAG, "DownloaderTask.onPreExecute()");
		...
		protected void onPostExecute(String[] strings) {
			...
			Log.v(TAG, "DownloaderTask.onPostExecute()");
			((DownloadFinishedListener)getActivity()).notifyDataRefreshed(strings);
		}
	}
}